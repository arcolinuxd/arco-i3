...
#sudo pacman -S --noconfirm --needed redshift		#You must need activated some location services
sudo pacman -S --noconfirm --needed xfburn
#sudo pacman -S --noconfirm --needed variety		#This is for wallpapers, you can use pywal
